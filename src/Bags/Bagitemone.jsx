  ...
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2" src="https://litb-cgis.rightinthebox.com/images/640x640/201907/wuwf1563536249697.jpg" />
      </div>  
