...
const Hikingequipmentsitemfive = () => {
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			src="https://s.alicdn.com/@sc04/kf/H113da1a7c45b4d20988850601a14c557Y.jpg_300x300.jpg"/>
      </div>  
...
export default Hikingequipmentsitemfive
