    ...
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			src="https://www.anacondastores.com/medias/BP90030615-green-white.jpg-SPOTWF-productHero?context=bWFzdGVyfGltYWdlc3w0MzA3Nzl8aW1hZ2UvanBlZ3xpbWFnZXMvaGY1L2hmYy8xMDA4ODY3NjE2MzYxNC9CUDkwMDMwNjE1LWdyZWVuLXdoaXRlLmpwZ19TUE9UV0ZfcHJvZHVjdEhlcm98MWIyZTYwOGI0MGIwMDM0NTcxZDlkNjA0OGJhNjlkNzI4MDQyNmM0NjIwNWYyZGRhMTFiNzJmY2RmODMwMjVhYQ"/>
      </div>  
      <div className='flex flex-col justify-center items-center mt-5'>
        <p className='text-lg'>YOGA BLANKET</p>
        <p className='text-xl font-bold'>10KWD</p>
      </div>
...
export default Survivalaiditemsix
