    ...
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			 src="https://www.anacondastores.com/medias/BP90040887-brown.jpg-SPOTWF-productHero?context=bWFzdGVyfGltYWdlc3w0NDA5N3xpbWFnZS9qcGVnfGltYWdlcy9oMWEvaDRiLzEwMDg4Njc5NjM3MDIyL0JQOTAwNDA4ODctYnJvd24uanBnX1NQT1RXRl9wcm9kdWN0SGVyb3wyYTY3M2ZkNGQ1MGViZDkyMTFjODlkMzA0NmNhMjllNjZmODg1MjBjNjFhNzkzNGRiMjk1Y2ZjMzk1OTdlMGIz"/>
       </div>  
      <div className='flex flex-col justify-center items-center mt-5'>
        <p className='text-lg'>FOLDING CAMPING TABLE</p>
...
export default Survivalaiditemthree
