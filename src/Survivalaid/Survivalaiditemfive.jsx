    ...
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			 src="https://www.anacondastores.com/medias/BP90030617-green.jpg-SPOTWF-productHero?context=bWFzdGVyfGltYWdlc3w1Nzk0OHxpbWFnZS9qcGVnfGltYWdlcy9oYTkvaGZkLzEwMDg4NjYzNTgwNzAyL0JQOTAwMzA2MTctZ3JlZW4uanBnX1NQT1RXRl9wcm9kdWN0SGVyb3wzNTM1ZGIyZGNmM2U1ZDA2ZmQyMWUwMDAxOWVmM2QxNzVkMGIxZWJhM2M1NzY2NDliZjk4MzM4ZmM5MjJlMGUz"/>
       </div>  
      <div className='flex flex-col justify-center items-center mt-5'>
        <p className='text-lg'>FOLDING CAMPING TABLE</p>
        <p className='text-xl font-bold'>30KWD</p>
      </div>
...
export default Survivalaiditemfive
