    ...
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
         			src="https://www.anacondastores.com/medias/BP90202137-black.jpg-SPOTWF-productHero?context=bWFzdGVyfGltYWdlc3w0NTc3NHxpbWFnZS9qcGVnfGltYWdlcy9oMGQvaGIzLzE0OTQ3NDE2NjM3NDcwL0JQOTAyMDIxMzctYmxhY2suanBnX1NQT1RXRl9wcm9kdWN0SGVyb3xkYzcyYzAzYWY3ZThjMzdmMzQxZDVlYzhjMWJjZmE3MjllYjM4MTVkZDlmMTliNDAyNmU4NzgzZmRkZjdjNzA2" />
      </div>  
      <div className='flex flex-col justify-center items-center mt-5'>
        <p className='text-lg'>FOLDING RECLINING CAMPING</p>
...
export default Survivalaiditemone
