    ...
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			src="https://www.anacondastores.com/medias/BP90030612-red-grey.jpg-SPOTWF-productHero?context=bWFzdGVyfGltYWdlc3w1Nzk3MDh8aW1hZ2UvanBlZ3xpbWFnZXMvaDViL2gxMi8xMDA4ODY0MDExODgxNC9CUDkwMDMwNjEyLXJlZC1ncmV5LmpwZ19TUE9UV0ZfcHJvZHVjdEhlcm98NDNlYzI5N2JjNzE0NTdhNTNjNTYxZTZkNzFhYmZlY2IyMDcyYjEyMDkzNTgzNDcwN2NiNjg1MjhiNTIxZGE1Nw"/>
      </div>  
      <div className='flex flex-col justify-center items-center mt-5'>
        <p className='text-lg'>PRESSURE SOLAR CAMPING SHOWER</p>
        <p className='text-xl font-bold'>15KWD</p>
      </div>
...
export default Survivalaiditemtwo
