...
const Fishingequipmentsitemthree = () => {
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			  src="https://cdn11.bigcommerce.com/s-55834/images/stencil/original/x/fishing-hooks__81495.original.jpg"/>
      </div>  
...
export default Fishingequipmentsitemthree
