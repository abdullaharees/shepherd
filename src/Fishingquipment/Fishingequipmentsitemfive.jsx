...
const Fishingequipmentsitemfive = () => {
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			src="https://cdn11.bigcommerce.com/s-55834/images/stencil/360x260/products/4004/15663/black-magic-stainless-steel-game-fishing-hook__81950.1561853286.jpg?c=2"/>
      </div>  
...
export default Fishingequipmentsitemfive
