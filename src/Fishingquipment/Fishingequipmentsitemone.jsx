...
const Fishingequipmentsitemone = () => {
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
         src="https://cdn11.bigcommerce.com/s-55834/images/stencil/360x260/products/3796/17905/shimano-sienna-reels__69936.1647761988.jpg?c=2"/>
      </div>  
...
export default Fishingequipmentsitemone
