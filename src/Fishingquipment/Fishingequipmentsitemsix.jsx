...
const Fishingequipmentsitemsix = () => {
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			  src="https://cdn11.bigcommerce.com/s-55834/images/stencil/360x260/products/5220/19407/mustad-hoodlum-hooks__46751.1665727214.jpg?c=2"/>
      </div>  
      <div className='flex flex-col justify-center items-center mt-5'>
        <p className='text-lg'>BURGUNDY</p>
        <p className='text-xl font-bold'>13KWD</p>
      </div>
...
export default Fishingequipmentsitemsix
