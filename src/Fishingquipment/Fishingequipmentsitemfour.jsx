...
const Fishingequipmentsitemfour = () => {
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        <img className="object-cover h-[25rem] w-[22rem] rounded-md mt-2"
			  src="https://cdn11.bigcommerce.com/s-55834/images/stencil/360x260/products/1016/11592/ball-sinkers__63632.1509079306.jpg?c=2"/>
      </div>  
      <div className='flex flex-col justify-center items-center mt-5'>
        <p className='text-lg'>60 L Hiking Backpack Rucksack</p>
        <p className='text-xl font-bold'>40KWD</p>
      </div>
...
export default Fishingequipmentsitemfour
