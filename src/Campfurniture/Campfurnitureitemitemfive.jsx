...
const Campfurnitureitemitemfive = () => {
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        ...
        src="https://cdn.shopify.com/s/files/1/0531/3822/7373/products/028b13a96c45ed9dd00bc4181bac2ff0_500x.jpg?v=1654918656" />
      </div>  
...
export default Campfurnitureitemitemfive
