  ...
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        ...
        src="https://cdn.shopify.com/s/files/1/0531/3822/7373/products/dcf517d5b8685104022f7ea5cd618c31_500x.jpg?v=1654920957"/>
      </div>  
...
export default Campfurniturefour
