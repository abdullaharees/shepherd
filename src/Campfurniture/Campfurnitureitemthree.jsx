  ...
  return (
    <div className='bg-[#c8c7c7]  rounded-sm'>
      <div className='w-[25rem] h-[25rem] rounded-md flex justify-center'>
        ...
        src="https://cdn.shopify.com/s/files/1/0531/3822/7373/products/395859a5c6e4b3a5492944682b5802c9_500x.jpg?v=1654933878" />
      </div>  
...
export default Campfurnitureitemthree
