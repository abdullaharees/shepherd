  ...
  return (
    <div className='w-[25rem] h-[15rem] bg-[white] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-sm'>
      <div className=' ml-5 flex flex-col '>
        <p className='mt-5 text-[1.2rem] font-semibold'>Partnerships Manager</p>
        <div>
          <div className='flex'>
            <MdLocationOn className='text-[#333333] mt-2' size={17}/>
            <p className='mt-1 ml-2'>Dar es Salaam</p>
          </div>
          <div className='flex'>
            <ImOffice className='text-[#333333] mt-2' size={17}/>
            <p className='mt-1 ml-2'>Business Services / Consultancy</p>
          </div>
          <div className='flex'>
            <div className='flex'>
            ...
            <div className='flex ml-7'>
              ...
              <p className='mt-1 ml-2'>Manager</p>
            </div>
          </div>
        </div>
...
export default Jobhomecomponenttwo
